        ...
        String action = request.getParameter("action");
         ...
         String sessionuser= request.getParameter("ssuser");
                ...
                if(action.equals("Submit")){
                 Account account = accountFacade.find(accountFacade.getAccountID(sessionuser));
                 account.setAccountEmail(email);
                 account.setAccountAddress(address);
                 account.setAccountPhoneNumber(phone);
                 account.setAccountImage("abc");
                 accountFacade.edit(account);
                 request.setAttribute("result", "Edit Successfully!");
