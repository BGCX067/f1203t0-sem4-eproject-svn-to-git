...
public class Claim implements Serializable {
    ...
    @NotNull
    @Size(min = 1, max = 10)
    @Column(name = "ClaimID", nullable = false, length = 10)
    ...
    public Claim(String claimID, double claimAmount, String claimReason, String claimAttachment, String claimHospitalName, String claimHospitalAddress) {
        this.claimID = claimID;
