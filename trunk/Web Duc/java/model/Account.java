...
@NamedQueries({
    ...
    @NamedQuery(name = "Account.findByAccountUsernamePassword", query = "SELECT a FROM Account a WHERE a.accountUsername = :accountUsername AND a.accountPassword = :accountPassword"), 
